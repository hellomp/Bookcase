...
$query = mysqli_query($dbc,"SELECT * FROM livro WHERE id_categoria = '$id_categoria'")
    ...
    <header class="mdl-layout__header">
      ...
      <div class="mdl-layout__header-row">
        ...
        <span class="mdl-layout-title">
          <?php
          $query_category = mysqli_query($dbc, "SELECT nome FROM categoria WHERE id = '$id_categoria'")
          or die (mysqli_error($dbc));
          $categoria =mysqli_fetch_array($query_category);
          echo $categoria['nome'];
          ?>
        </span>
